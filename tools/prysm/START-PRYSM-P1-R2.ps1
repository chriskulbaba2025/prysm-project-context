...
Require-GateValue $gate 'R2_TRACKED_PROOF_RECOVERY_FILE' 'proof/P1/reopen/P1_R2_RUN2_TRACKED_PROOF_RELOCATION_RECOVERY_2026-09-06.md'
...
Verify-BoundFile $gate 'R2_TRACKED_PROOF_RECOVERY_FILE' 'R2_TRACKED_PROOF_RECOVERY_COMMIT'
