...
| P-B17 | Existing `UNAVAILABLE` / `PARTIAL` evidence is rendered with a truthful source-specific actionability roadmap, while AVAILABLE control has no fabricated deferred or Appendix row | evidence source status -> deterministic roadmap projection -> report detail/deferred/Evidence Appendix consumer | YES | `p6-unavailable-roadmap.test.js`, `approved-pages.test.js`; Whole-App render lifecycle | VERIFIED at exact candidate SHA `3fb3042c04d874d44ff7f984bf279fd7b452327c` | P6 direct proof 24/24 covers unavailable accessibility, partial crawl/accessibility, unavailable CrUX with available lab data, GA4/backlinks, Evidence Appendix positive/negative cases, and available control; Whole-App P-B01-P-B16 passed 87/87. |
