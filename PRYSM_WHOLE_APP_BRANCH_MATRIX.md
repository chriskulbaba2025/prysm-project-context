...
| P-B17 | Existing `UNAVAILABLE` / `PARTIAL` evidence is rendered with a truthful source-specific actionability roadmap, while AVAILABLE control has no fabricated deferred row | evidence source status -> deterministic roadmap projection -> report detail/deferred consumer | YES | `p6-unavailable-roadmap.test.js`, `approved-pages.test.js`; Whole-App render lifecycle | VERIFIED at exact candidate SHA `7580d9b479190bc95065f4edc66245d083f575f7` | P6 direct proof covers unavailable accessibility, partial crawl/accessibility, unavailable CrUX with available lab data, GA4/backlinks, and available control; Whole-App P-B01-P-B16 passed 87/87. |
...
P6 adds P-B17 for status-preserving actionability rendering at `7580d9b479190bc95065f4edc66245d083f575f7`. Whole-App execution remains P-B01 through P-B16 and the P6 direct branch proof is separately executed because the controlled Whole-App fixture has all sources available.
