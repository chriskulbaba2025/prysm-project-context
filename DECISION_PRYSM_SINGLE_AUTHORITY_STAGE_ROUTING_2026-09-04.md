...
The repaired process was then exercised in isolated Git repositories through the full public launcher/preflight/routing chain with eight deterministic regression cases: 8 PASS / 0 FAIL. The cases cover valid Brad OUTCOME_REVIEW without Codex, real stale evidence, missing rendered-proof binding, candidate identity mismatch, Builder single-authority handoff, non-Builder Codex independence, recognized diagnostic quarantine, and exact blocking of an unknown dirty file.
