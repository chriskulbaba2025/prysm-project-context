...
| P-B17 | Existing `UNAVAILABLE` / `PARTIAL` evidence is rendered with a truthful source-specific actionability roadmap, while AVAILABLE control has no fabricated deferred or Appendix row | evidence source status -> deterministic roadmap projection -> report detail/deferred/Evidence Appendix consumer | YES | `p6-unavailable-roadmap.test.js`, `approved-pages.test.js`; Whole-App render lifecycle | VERIFIED at exact candidate SHA `aa9383bdab9047cfbaf3316d5dbca5cd2a0cb355` | Exact-candidate closure reran the P6 roadmap suite 4/4 and approved-page lifecycle 21/21, including runAudit -> review -> approveAudit committed-artifact reload and persisted deferred/appendix output; Whole-App gate reports P-B01-P-B17 PASS.
